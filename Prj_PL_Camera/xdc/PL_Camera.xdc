...
set_property PACKAGE_PIN R3 [get_ports {TFT_RGB_R[4]}]
set_property PACKAGE_PIN U2 [get_ports {TFT_RGB_R[3]}]
set_property PACKAGE_PIN U1 [get_ports {TFT_RGB_R[2]}]
set_property PACKAGE_PIN T3 [get_ports {TFT_RGB_R[1]}]
set_property PACKAGE_PIN T2 [get_ports {TFT_RGB_R[0]}]
set_property PACKAGE_PIN M1 [get_ports {TFT_RGB_G[5]}]
set_property PACKAGE_PIN M5 [get_ports {TFT_RGB_G[4]}]
set_property PACKAGE_PIN M4 [get_ports {TFT_RGB_G[3]}]
set_property PACKAGE_PIN L2 [get_ports {TFT_RGB_G[2]}]
set_property PACKAGE_PIN L1 [get_ports {TFT_RGB_G[1]}]
set_property PACKAGE_PIN P3 [get_ports {TFT_RGB_G[0]}]
set_property PACKAGE_PIN N2 [get_ports {TFT_RGB_B[4]}]
set_property PACKAGE_PIN P1 [get_ports {TFT_RGB_B[3]}]
set_property PACKAGE_PIN N5 [get_ports {TFT_RGB_B[2]}]
set_property PACKAGE_PIN N4 [get_ports {TFT_RGB_B[1]}]
set_property PACKAGE_PIN M2 [get_ports {TFT_RGB_B[0]}]
